    ...
    class Program
    {
        ...
        */
        var wordsAndDefinitions = new Dictionary<string, string>() {
            {"hot dog", "weird cylindric food"},
            {"dog", "slobbery animal"},
            {"hot", "not cold"},
            {"hot diggety dog", "an exclamation conveying delight"}
        };
        ...
        */
        Console.WriteLine(wordsAndDefinitions["hot dog"]);
        Console.WriteLine(wordsAndDefinitions["dog"]);
